process ffe_model {
  ...
  output:
  path("solids_after_${sub_areas}_subareas_*.csv"), emit: solids_data
  path("solids_after_${sub_areas}_subareas_*.png"), emit: solids_plot

  script:
  """
  python /model_ffe.py ${input_data} ${flow_data} --t_min ${t_min} --t_max ${t_max}
  """
}
